	...
	<div class="container">
		<div id="base">
			...
			<div id="forms">
				...
				<iframe class="iframe" src="<?php echo $execDir; ?>/plot2.html" width="100%" frameborder="none" style="margin-top:-5px;"></iframe>
				<iframe class="iframe" src="<?php echo $execDir; ?>/plot3.html" width="100%" frameborder="none" style="margin-top:-5px;"></iframe>
				<iframe class="iframe" src="<?php echo $execDir; ?>/plot4.html" width="100%" frameborder="none" style="margin-top:-5px; border-radius:0 0 8px 8px"></iframe>
				<?php ?>
